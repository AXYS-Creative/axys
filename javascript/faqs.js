...
const questionsData = [
      ...
      },
    {
      ...
      },
      {
        ...
        answer:
          "This is where the pause feature shines. Anytime the workload becomes light, you can pause your plan which stops all charges. Then you can easily start up again when you do need our services.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "AXYS Creative is driven by only two people: Aaron & Bailey Garcia. This helps with quick decision making & promotes swift turn around. We can each handle the design & development aspect of the work.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "No. Please be aware that we don't offer any refunds at this time.",
      },
];
...
faqsList.innerHTML = htmlStringFaq;
